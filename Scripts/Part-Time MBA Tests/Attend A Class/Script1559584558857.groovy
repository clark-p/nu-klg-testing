...
WebUI.navigateToUrl('http://cms9dev.kellogg.northwestern.edu/programs/part-time-mba.aspx')
...
WebUI.click(findTestObject('Page_Part-Time MBA Prgoram Kellogg School of Management/Page_Kellogg School of Management - Visit an Evening  Weekend MBA Program Class/span_We hope to see you on campus soon'))
